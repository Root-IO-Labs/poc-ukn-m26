...
- **wolfSSL JNI v1.13.0** - JSSE provider (wolfJSSE) with JNI bindings to wolfSSL FIPS (Java 8 compatible)
- **Ubuntu 22.04 Jammy** - Container base (Eclipse Temurin official image)

> **Note:** Java 8 uses wolfSSL JNI v1.13.0-stable for Java 8 compatibility. v1.13.0 adds Java 17 support and works correctly with Java 8. The wolfCrypt JNI master branch is used as it doesn't have Java version dependencies and supports modern wolfSSL headers.
...
|----------|---------|-------------|
| `JAVA_HOME` | `/usr/local/openjdk-8` | Java installation directory |
